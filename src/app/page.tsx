    ...
    <div className='flex relative overflow-hidden antialiased flex-col items-center justify-between pt-0'>
        <div className='flex flex-col gap-8 max-w-6xl sm:flex-row min-h-screen pt-10 sm:pt-28 px-4'>
          <div className='text-left font-semibold text-white flex flex-col gap-8'>
            ...
            <h3 className='text-md'>APTUS revolutionizes hiring by eliminating biases, ensuring fair assessments, and delivering transparent feedback for both companies and candidates, forging a future of equitable and positive recruitment experiences.</h3>
            <div>
        ...
        <h2 className='text-white'>© 2023 APTUS</h2>
